...
const ConfirmarParticipacionRuta = ({ confirmandoEliminar, setConfirmandoActivar }) => {
    ...
    return (
        <React.Fragment>
            ...
            <Card className="p-2">
                <Card.Body>
                    <p className="eliminar-ruta">¿Estás seguro de que deseas {ruta.activa ? "desactivar" : "activar"} {ruta.titulo}?</p>
